...
## 11 skills (v0.6 — 9 base + 2 adaptive)

| Skill | 발동 시점 | Phase 매핑 |
|---|---|---|
| [kickoff-project.md](kickoff-project.md) | 새 프로젝트 시작 | 00 Intake |
| [synthesize-local-layer.md](synthesize-local-layer.md) ⭐ | Phase 00 Local Capability Synthesis sub-step (v0.6) | 00 Intake (sub-step) |
| [review-local-layer.md](review-local-layer.md) ⭐ | local skill/role draft 생성 후 (HC-10 delta check) | 00 Intake (sub-step) |
| [plan-blueprint.md](plan-blueprint.md) | Intake + Local Capability 완료 후 | 01 Blueprint |
| [plan-module.md](plan-module.md) | Blueprint 후 모듈마다 | 02 ModulePlan |
| [request-codex-review.md](request-codex-review.md) | cross-review / 텍스트 검토 | 01 / 02 / 04 |
...
| [harness-amend.md](harness-amend.md) | base 하니스 수정 필요 | meta — HARNESS §6 |
