...
artifact: base_skill
version: v0.2
supersedes: v0.1 (codex r1 block — 2 blocker + 2 major 반영)
date: 2026-05-28
author: claude
status: proposed
references:
  - hara_promotion: DECISIONS.md ADR-025 (Hara v2.3 — HC-13 신설 + 본 skill 도입)
  - precedent: examples/starpin/.harness/runs/mobile-e2e-20260528-ios-login-smoke.json (HC-12 functional smoke — visual review 의 input source)
...
- **v0.2 carry**: 자동 a11y audit 통합 (Maestro 의 a11y inspector 결과 + axe-core)
- **v0.3 carry**: VRT (visual regression) 옵션 — baseline 안정화 후 (starpin v0.16+ 후보)
- **v0.4 carry**: 자동 design system 일치 검증 (style guide doc 와 PNG 의 색/font 추출 비교)
